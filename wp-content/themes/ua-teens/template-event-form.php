		...
		<div class="container">
          ...
          <input type="hidden" name="page_link" value="<?php the_permalink();?>">
					...
					<div class="form-group">
						<label for="event-field-name"><?php echo esc_html( pll__( 'Ваше Імʼя' ) ); ?></label>
						<input type="text" name="name" class="form-control" id="event-field-name" required>
					</div>
					<div class="form-group">
						<label for="event-field-last-name"><?php echo esc_html( pll__( 'Ваше Прізвище' ) ); ?></label>
						<input type="text" name="last_name" class="form-control" id="event-field-last-name" required>
					</div>
					<div class="form-group">
						<label for="event-field-birthday"><span>(<?php echo esc_html( pll__( 'тинейджера' ) ); ?>)</span><?php echo esc_html( pll__( 'Дата народження' ) ); ?></label>
						<input type="date" class="form-control birthday" id="event-field-birthday" name="birthday" required>
					...
					<div class="form-group">
						<label for="event-field-phone"><?php echo esc_html( pll__( 'Ваш номер телефону' ) ); ?></label>
						<input type="tel" name="phone" class="form-control" id="event-field-phone" required>
					</div>
